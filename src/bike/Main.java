...
public class Main {
	...
	public static void main(String[] args) {
        // As of right now, the directory for supporting files must be hardcoded.
		if (RecordsIO.setWorkingDirectory("/home/ekoval/Programming/workspaceJAVA/BikeShop/BikeShopFiles/")) {
